...
<form class="form-horizontal" name="classform" id="classform" action="config.php" method="post" onsubmit="return xoopsFormValidate_classform();" enctype = "multipart/form-data">
