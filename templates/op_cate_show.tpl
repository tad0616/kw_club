...
<{if $smarty.session.isclubAdmin}>
  ...
  <a href="<{$xoops_url}>/modules/kw_club/admin/config.php?type=<{$type}>&op=cate_form&cate_id=<{$arr[0]}>" class="btn btn-warning"><{$smarty.const._TAD_EDIT}></a>
  <a href="<{$xoops_url}>/modules/kw_club/admin/config.php?type=<{$type}>&op=cate_form" class="btn btn-primary"><{$smarty.const._TAD_ADD}></a>
<{/if}>
