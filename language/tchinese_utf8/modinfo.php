...
define('_MI_KWCLUB_ADMENU2_DESC', '新增教師');
define('_MI_KWCLUB_ADMENU3', '新增類型');
define('_MI_KWCLUB_ADMENU3_DESC', '新增類型');
define('_MI_KWCLUB_ADMENU4', '新增地點');
define('_MI_KWCLUB_ADMENU4_DESC', '新增地點');
define('_MI_KWCLUB_ADMENU5', '報名統計管理');
define('_MI_KWCLUB_ADMENU5_DESC', '報名統計管理');
...
define('_MI_KW_CLUB_SHOW_NUM', '每頁顯示文章數');
define('_MI_KW_CLUB_SHOW_NUM_DESC', '設定每頁顯示文章數（分頁用）');

define('_MI_KW_CLUB_START_DATE', '社團報名起始時間');
define('_MI_KW_CLUB_START_DATE_DESC', '社團報名起始時間說明');
